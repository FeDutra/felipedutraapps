      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full max-w-full min-w-0">
        ...
        <div className="lg:col-span-5 space-y-8 min-w-0">
          <SafeBlock name="Sinais de Atenção">
            <div className="bg-[#b8283e]/5 border border-[#b8283e]/15 rounded-3xl p-6">
              ...
              <div className="space-y-4">
                {topAttentionSignals.map((sig) => {
                  const bgClass = sig.severity === 'critical' ? 'bg-[#b8283e]/5 border-[#b8283e]/15' : 'bg-[#cbb291]/5 border-[#cbb291]/15';
                  const dotClass = sig.severity === 'critical' ? 'bg-[#b8283e] shadow-[0_0_8px_rgba(184, 40, 62,0.4)]' : 'bg-[#cbb291]';
