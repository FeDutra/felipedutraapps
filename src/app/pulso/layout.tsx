...
export default function PulsoLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#cf735c] text-[#fbf9f5] w-full selection:bg-white/20 flex flex-col xl:flex-row overflow-x-hidden">
      {isLivePage ? (
        ...
        <>
          ...
          <nav className="xl:hidden relative p-3 md:p-4 flex flex-col items-stretch justify-between gap-3 border-b border-white/10 bg-[#cf735c]/90 backdrop-blur-xl sticky top-0 z-50 w-full max-w-full overflow-x-hidden">
          ...
          <aside className="hidden xl:flex flex-col justify-between w-64 min-w-[16rem] h-screen static xl:sticky top-0 border-r border-white/10 bg-[#cf735c]/95 backdrop-blur-2xl z-50 p-4 shrink-0">
