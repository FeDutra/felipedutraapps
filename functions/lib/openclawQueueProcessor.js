...
exports.processOpenClawQueue = (0, scheduler_1.onSchedule)({
    ...
    v2_1.logger.info("⚡ processOpenClawQueue DESATIVADO para dar lugar ao OpenClaw real.");
    return;
