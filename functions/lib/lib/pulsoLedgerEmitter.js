...
exports.emitPulsoLedgerEvents = emitPulsoLedgerEvents;
...
function hasSensitiveData(obj) {
    ...
    if (typeof obj === "string") {
        ...
        if (lower.includes("-----begin private key-----") || lower.includes("bearer ey"))
            return true;
        return false;
    }
 ...
 */
async function emitPulsoLedgerEvents(events, db) {
...
//# sourceMappingURL=pulsoLedgerEmitter.js.map